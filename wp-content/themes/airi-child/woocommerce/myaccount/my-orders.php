<style>
.mukta_my_order, .mukta_my_order th, .mukta_my_order td {
...
.mukta_my_order .order .order-number {
	font-weight: 600;
}
.mukta_my_order .order-actions .button {
	padding: 3px 8px;
...
if ( $customer_orders ) : ?>
	...
	<table class="shop_table shop_table_responsive my_account_orders mukta_my_order">
