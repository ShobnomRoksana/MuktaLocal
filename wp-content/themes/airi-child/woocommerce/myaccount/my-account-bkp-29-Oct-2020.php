...
<div class="tabbtnwrap">
  ...
  <a class="tablink" href="<?php echo esc_url( wc_get_account_endpoint_url( 'customer-logout' ) ); ?>">LOG OUT</a>
</div>
...
<div class="tabcontentwrap">
  ...
  <div id="Orders" class="tabcontent">
    <div class="row profile_wishlist_wrap">
      <div class="col-md-4">
        <img class="img-fluid" src="/wp-content/uploads/2020/10/my-orders.png" />
      </div>
      <div class="col-md-8">
        <h3 class="profile_wl_title">My Wishlist</h3>
        <p style="font-weight: 600;">Follow your purchases, check the delivery status of your orders, access the exchange information.</p>

        <?php
          wc_get_template( 'myaccount/orders.php', array( 'order' => $order ) );
        ?>
      </div>
    </div>
  ...
  <div id="Wishlist" class="tabcontent">
    ...
    echo '<div class="row text-center profile_wishlist_wrap">
            <div class="col-md-12">
              <h3 class="profile_wl_title">My Wishlist</h3>
              <p style="font-weight: 600;">Create your whishlist: save up to 50 items and add them to your shopping bag as they become available.</p>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-10">'
