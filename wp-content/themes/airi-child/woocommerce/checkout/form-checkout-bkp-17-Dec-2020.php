...
$(window).load(function() {
    ...
    $( "ul.wc_payment_methods.payment_methods.methods > li > .payment_box.payment_method_sslcommerz" ).html ('<img class="img-fluid" src="https://securepay.sslcommerz.com/public/image/SSLCommerz-Pay-With-logo-All-Size-01.png" />');
});
