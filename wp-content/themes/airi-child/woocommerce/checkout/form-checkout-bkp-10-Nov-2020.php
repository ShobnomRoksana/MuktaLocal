...
<div id="checkoutTop" class="row">
    <div class="col-md-8" id="pp">
        ...
        <div class="row easy-fix"  style="padding-left: 15px;padding-right: 15px;">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-xs-6 text-center top-white-box"><a href="">Shopping Bag</a></div>
                    <div class="col-xs-6 text-center top-pink-box"><a href="">Proceed with Order</a></div>
                </div>
            </div>
        </div>
        <div class="row easy-fix"  style="padding-left: 15px;padding-right: 15px;">
...
<div class="row">
    <form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" >
            ...
            <div class="row easy-fix"  style="padding-left: 15px;padding-right: 15px;">
                <div class="col-sm-12">
                    <div class="collapse-row row">
                        ...
                        <div id="display-block" class="col-sm-12 collapse-container" style="display: none;background: #fed2c7;border-radius: 16px;padding: 25px;">
        ...
        <div id="gg" class="col-md-4 custom-shopping-bag-modify-box">
          <div style="top: 133px;">
            <div id="order_review_heading" class="row"  style="padding-left: 15px;padding-right: 15px;">
                <div class="col-sm-7">
...
$(window).load(function() {
    ...
    $( "ul.wc_payment_methods.payment_methods.methods > li > .payment_box.payment_method_sslcommerz" ).html ('<a href="https://www.sslcommerz.com/" title="SSLCommerz" alt="SSLCommerz"><img class="img-fluid" src="https://securepay.sslcommerz.com/public/image/SSLCommerz-Pay-With-logo-All-Size-01.png" /></a>');
});
